...
export const cactus = [
  {
    idProducto: 1,
    nombreProducto: "Asiento de Suegra",
    precioProducto: 350,
    luz: "Pleno sol (Mínimo 5-6 horas diarias)",
    riego: "Muy bajo (Solo cuando el sustrato esté completamente seco)",
    Funcion: "Planta de ornato",
    descripcion: "Cactus globular clásico con espinas amarillas muy brillantes. De crecimiento lento pero sumamente ornamental.",
    imagen: "https://upload.wikimedia.org/wikipedia/commons/2/25/Echinocactus_grusonii_%28aka%29.jpg"
  },
  {
    idProducto: 2,
    nombreProducto: "Cactus de Navidad",
    precioProducto: 220,
    luz: "Luz brillante indirecta (No tolera sol directo fuerte)",
    riego: "Moderado (Mantener ligera humedad sin encharcar)",
    Funcion: "Planta con flor",
    descripcion: "Cactus tropical sin espinas que produce abundantes y hermosas flores colgantes en tonos rosas, rojos o blancos.",
    imagen: "https://content.elmueble.com/medio/2020/11/27/cactus-de-navidad_7f63003e_674x446.jpg"
  },
  {
    idProducto: 3,
    nombreProducto: "Cactus Órgano",
    precioProducto: 580,
  ...
  {
    idProducto: 4,
    nombreProducto: "Cactus San Pedro",
    precioProducto: 490,
    luz: "Pleno sol o sombra parcial",
    riego: "Bajo (Regar de forma espaciada durante el año)",
    Funcion: "Planta columnar",
    descripcion: "Cactus de rápido crecimiento con columnas de color verde azulado. Muy resistente y fácil de cuidar.",
    imagen: "https://tiajuanasplants.com/cdn/shop/files/682_SanPedrovariegado25-35cmaprox.jpg?v=1702911644&width=1445"
  },
  {
    idProducto: 5,
    nombreProducto: "Cactus Orejas de Conejo",
    precioProducto: 150,
    luz: "Sol directo o luz muy brillante",
    riego: "Muy bajo (Sustrato completamente seco antes de regar)",
    Funcion: "Planta de ornato",
    descripcion: "Variedad de nopal miniatura con almohadillas ovaladas cubiertas de pequeños puntos amarillos o blancos que parecen vello.",
    imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGqBdAM_lOpT8sSCQImuFWCe0LdnLOo0qpjmt9sgtR6oSY3pUDGGVEJ_di&s=10"
  },
  {
    idProducto: 6,
    nombreProducto: "Cactus de Computadora",
    precioProducto: 180,
    luz: "Luz brillante indirecta o sol parcial",
    riego: "Bajo (Soportan bien la falta de agua en interiores)",
    Funcion: "Planta de ornato",
    descripcion: "Cactus de aspecto columnar y ramificado. Se le asocia popularmente con la absorción de ondas electromagnéticas.",
    imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKC1YHVS_BUcsggWRjXDDrDxw2gDfUJpWgDD7Kppden_Md96yEzsbFL33w&s=10"
  },
  {
    idProducto: 7,
    nombreProducto: "Cactus Injertado (Mihanovichii)",
    precioProducto: 260,
    luz: "Luz brillante indirecta (El sol directo quema su color)",
    riego: "Bajo (Evitar humedad retenida en la base)",
    Funcion: "Planta de ornato",
    descripcion: "Llamativo cactus de color rojo, amarillo o neón que crece injertado sobre una base verde de otra especie.",
    imagen: "https://http2.mlstatic.com/D_NQ_NP_729319-MLM70724435273_072023-O.webp"
  },
  {
    idProducto: 8,
    nombreProducto: "Cactus Candelabro",
    precioProducto: 650,
    luz: "Pleno sol directo",
    riego: "Muy bajo (Solo en primavera y verano, casi nulo en invierno)",
    Funcion: "Planta columnar",
    descripcion: "Cactus escultural imponente que desarrolla múltiples ramificaciones parecidas a los brazos de un candelabro antiguo.",
    imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7a5JhVKveDLs2KrDs1SigU61nXi4zHQ4dl1D0zvSRrs3st9a7ZkMvvw4&s=10"
  },
  {
    idProducto: 9,
    nombreProducto: "Cactus Estrella (Astrophytum)",
    precioProducto: 210,
    luz: "Luz brillante / Sol filtrado",
    riego: "Muy bajo (Extremadamente sensible al exceso de riego)",
    Funcion: "Planta de ornato",
    descripcion: "Cactus esférico sin espinas comunes, decorado con pequeños puntos blancos que simulan un patrón de estrellas.",
    imagen: "https://fichas.infojardin.com/foto-cactus/astrophytum-ornatum.jpg"
  },
  {
    idProducto: 10,
    nombreProducto: "Cactus Piedra (Pelecyphora)",
    precioProducto: 320,
    luz: "Pleno sol / Muy buena ventilación",
    riego: "Mínimo (Regar únicamente cuando empiece a lucir ligeramente arrugado)",
...
export const suculentas = [
  {
    idProducto: 1,
    nombreProducto: "Echeveria Elegante",
    precioProducto: 150,
    luz: "Sol directo / Luz brillante",
    riego: "Bajo (Solo cuando el sustrato esté 100% seco)",
    Funcion: "Planta de ornato",
    descripcion: "Hermosa suculenta con forma de roseta compacta de color azul plateado. Ideal para macetas exteriores o ventanas soleadas.",
    imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9breIFZbI0ocHSqTyUS_ipc2gcewVbVcHYaHWcMxbkJvebDlO4jPfNwC8&s=10"
  },
  {
    idProducto: 2,
    nombreProducto: "Planta de Jade",
    precioProducto: 250,
    luz: "Luz brillante indirecta o pleno sol",
    riego: "Moderado (Dejar secar la tierra por completo entre riegos)",
    Funcion: "Planta de ornato",
    descripcion: "Conocida como la planta de la abundancia. Desarrolla un tallo grueso tipo árbol y hojas carnosas de un verde intenso.",
    imagen: "https://hips.hearstapps.com/hmg-prod/images/jade-plant-1-645157c445e14.jpg"
  },
  {
    idProducto: 3,
    nombreProducto: "Suculenta Rosario",
    precioProducto: 180,
    luz: "Luz brillante indirecta",
    riego: "Bajo (Sensible al exceso de agua, regar con moderación)",
    Funcion: "Planta colgante",
    descripcion: "Espectacular planta colgante con hojas esféricas que parecen perlas verdes. Perfecta para repisas o macetas elevadas.",
    imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0dqZY4b12MDx4IA52k3o0YRajLpMGFbmtMLaYjZMZTQ&s=10"
  },
  {
    idProducto: 4,
    nombreProducto: "Haworthia Cebra",
    precioProducto: 120,
    luz: "Luz indirecta / Semicubierta",
    riego: "Bajo (Muy tolerante a la sequía, ideal para interiores)",
    Funcion: "Planta de ornato",
    descripcion: "Suculenta compacta de hojas color verde oscuro con rayas blancas en relieve que recuerdan a una cebra.",
    imagen: "https://images.unsplash.com/photo-1536882240095-0379873feb4e?q=80&w=400"
  },
  {
    idProducto: 5,
    nombreProducto: "Sedum Burrito",
    precioProducto: 190,
    luz: "Luz brillante / Sol directo suave",
    riego: "Bajo (Las hojas almacenan una gran cantidad de agua)",
    Funcion: "Planta colgante",
    descripcion: "Tallos colgantes densamente cubiertos de hojas carnosas y redondeadas de color verde grisáceo. Muy vistosa.",
    imagen: "https://images.unsplash.com/photo-1512428813834-c702c7702b78?q=80&w=400"
  },
  {
    idProducto: 6,
    nombreProducto: "Rosa del Desierto",
    precioProducto: 450,
    luz: "Pleno sol (Mínimo 6 horas diarias)",
    riego: "Moderado en verano, casi nulo durante el invierno",
    Funcion: "Planta con flor",
    descripcion: "Desarrolla un tronco grueso y escultural (cáudice) coronado por hermosas flores en tonos rosados o rojos.",
    imagen: "https://static.bainet.es/clip/760a72af-3bf4-4882-8c3d-a0f718c295f6_source-aspect-ratio_1200w_0.jpg"
  },
  {
    idProducto: 7,
    nombreProducto: "Garrita de Oso",
    precioProducto: 220,
    luz: "Luz brillante / Sol directo matutino",
    riego: "Bajo (Evitar mojar sus hojas aterciopeladas)",
    Funcion: "Planta de ornato",
    descripcion: "Hojas rechonchas y velludas con pequeñas puntas de color rojo oscuro que asemejan la garra de un osezno.",
    imagen: "https://todoparatuhuerta.com/wp-content/uploads/2020/08/Cotyledon-Tomentosa-4-min.jpg"
  },
  {
    idProducto: 8,
    nombreProducto: "Lengua de Suegra (Sansevieria)",
    precioProducto: 300,
    luz: "Todo tipo (Sombra, luz indirecta o pleno sol)",
    riego: "Muy bajo (Altamente resistente a la falta de agua)",
    Funcion: "Purificadora de aire",
    descripcion: "Planta de hojas verticales y estilizadas. Excelente purificadora de aire según la NASA y virtualmente indestructible.",
    imagen: "https://images.unsplash.com/photo-1596547609652-9cf5d8d76921?q=80&w=400"
  },
  {
    idProducto: 9,
    nombreProducto: "Euphorbia Trigona",
    precioProducto: 380,
    luz: "Pleno sol o luz muy brillante",
    riego: "Bajo (Sustrato completamente seco antes de regar)",
    Funcion: "Planta de ornato",
    descripcion: "Suculenta de crecimiento vertical que imita la forma de un cactus, con crestas espinosas cubiertas de hojas verdes.",
    imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSratUXjm4qWFYQ34-7hZ59pBjHSZKQKipLG2tDHTq9ZjeX3ChAUQnlubA&s=10"
  },
  {
    idProducto: 10,
    nombreProducto: "Siempre Viva",
    precioProducto: 130,
    luz: "Pleno sol / Altamente resistente al frío",
    riego: "Bajo (Soporta heladas y climas extremos mucho mejor)",
    Funcion: "Planta de ornato",
